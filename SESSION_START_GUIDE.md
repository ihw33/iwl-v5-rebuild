...
/docs/sessions/session_[번호]/Session[번호]_Summary.md
...
git add -A
git commit -m "feat: Session [번호] 완료 - [핵심 작업 요약]
...
```bash
# 다음 세션 폴더 생성
mkdir /docs/sessions/session_[다음번호]

# 시작 메시지 작성
/docs/sessions/session_[다음번호]/SESSION_[번호]_START.md
```
...
### 다음 채팅방에서:
```
Session [번호] 시작. 경로: /Users/m4_macbook/iwl-v5-rebuild
PROJECT_STATUS.md 확인 후 git pull, 그 다음 [작업] 시작
```
