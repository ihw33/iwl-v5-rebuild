...
### S1-A3 "추상화 없음"의 의미
- **이론**: 추상 개념이 전혀 없는 상태
- **실행**: 타인과 공유할 수 있는 개념이 없어 협업 불가
- **체험**: 각자가 각자의 감각적 경험만 가짐
- **예시**: 
  - 같은 "버튼"을 봐도 A는 "파란 네모", B는 "튀어나온 것"
  - 공통 언어(추상 개념)가 없어 소통 불가
...
### S2로의 준비
- S1-A3: "이것은 둥글고 파란 플라스틱" (개인적 경험)
- S2-A3: "이것은 내게 안정감을 주는 형태" (첫 의미 부여, 공유 가능성 시작)
